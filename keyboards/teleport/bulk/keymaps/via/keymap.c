/* Copyright 2025 Moritz Plattner
 *
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT(    /* keymap for layer 0 */
        KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_PSCR,     RM_TOGG,     KC_HOME, KC_END,  KC_SCRL, KC_PAUSE,
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,                             KC_RALT, KC_RGUI, MO(_FN1),KC_RCTL,     KC_LEFT, KC_DOWN, KC_RGHT,     KC_P0,   KC_PDOT
    ),
    ...
    [GAME] = LAYOUT(    /* keymap for layer 1 - GAME disables WIN key and has RGB layer indicators */
        ...
        KC_TRNS, KC_NO,   KC_TRNS,                   KC_TRNS,                            KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,     KC_TRNS, KC_TRNS, KC_TRNS,     KC_TRNS, KC_TRNS
    ),
    ...
    [_FN1] = LAYOUT(    /* keymap for layer 2 */
        ...
        KC_TRNS, TG(GAME),KC_TRNS,                   KC_TRNS,                            KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,     KC_TRNS, KC_TRNS, KC_TRNS,     KC_TRNS, KC_TRNS
    ),
};
